...
- **`ImportSelectionsMenuItem.lua`** / **`ImportSelectionsDialog.lua`** / **`ImportSelectionsTask.lua`** — the round-trip import. The task resolves PicPeak photos to local files by `source_filename` stem, then optionally by trailing digit run.
